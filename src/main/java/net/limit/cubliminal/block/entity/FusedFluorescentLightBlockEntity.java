...
public class FusedFluorescentLightBlockEntity extends BlockEntity {
	...
	public FusedFluorescentLightBlockEntity(BlockPos pos, BlockState state) {
		super(CubliminalBlockEntities.FUSED_FLUORESCENT_LIGHT_BLOCK_ENTITY, pos, state);
	}
	...
	public static void tick(World world, BlockPos pos, BlockState state, FusedFluorescentLightBlockEntity blockEntity) {
		if (!world.isClient) {
			++blockEntity.age;
